...
abstract class AppLocalizations {
  ...
  /// No description provided for @yourFavoritePlacesWillAppearHere.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @newPasswordConfirmationNoMatch.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @errorFetchingCountries.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @unsupportedCountry.
  ///
  /// In en, this message translates to:
  /// **'Sorry, we do not support your country ({country}) yet. We are working to expand!'**
